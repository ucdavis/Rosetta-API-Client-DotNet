...
![Rosetta API Spec](https://img.shields.io/badge/Rosetta%20API%20Spec-v1.0.39-blue)
...
await client.Api.StudentsGETAsync(limit: 25);
await client.Api.EmployeesGETAsync(department: "123456");
